...
export class CircleFish extends Fish {
  ...
  update() {
    ...
    this.x = this.baseX + Math.cos(this.time) * radius;
    this.y = this.baseY + Math.sin(this.time) * radius;
  }
}

export class SquireFish extends Fish {
  ...
  update() {
    ...
    this.x = this.baseX + this.side;
    this.y = this.baseY + this.side;
