...
import './styles.css';
import { FishManager, HorizontalFish, CrissCrossFish, SinusFish, StandingFish, CircleFish, SquireFish} from './fish';
...
manager.addFish(new StandingFish(aquarium, fish2, 200, 200, 0, 0));
manager.addFish(new CircleFish(aquarium, fish2, 300, 200, 1.5))
manager.addFish(new SquireFish(aquarium, fish2, 200, 200, 1.5))
